...
full_contributions_library_name = os.path.join("/Volumes/Liam's Works/Python/mediocre coding idea/","contributions-adblock-library-v1.txt")
official_library = []
user_input = ""
selected = False
selected2 = False
